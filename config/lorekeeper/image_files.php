...
return [
    ...
    */
    ...
    'rank_card_background' => [
        'name'        => 'Rank Card Background',
        'description' => 'Background used for rank cards generated by the Discord bot. PNG format, 500px x 200px.',
        'filename'    => 'rank_card_background.png',
    ],
];
