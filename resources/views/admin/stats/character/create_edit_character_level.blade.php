...
@include('widgets._loot_select', ['loots' => $level->rewards, 'showLootTables' => false, 'showRaffles' => false, 'showRecipes' => true])
...
@include('widgets._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'pets' => $pets, 'gears' => $gears, 'weapons' => $weapons, 'tables' => $tables, 'raffles' => $raffles, 'awards' => $awards,  'recipes' => $recipes, 'showLootTables' => false, 'showRaffles' => false, 'showRecipes' => true])
