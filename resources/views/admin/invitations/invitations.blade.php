...
@else
            ...
            <div class="mb-4 logs-table">
                <div class="logs-table-header">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-2">
                            <div class="logs-table-cell">Generated by</div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="logs-table-cell">Used by</div>
                        </div>
                        <div class="col-6 col-md-2">
                            <div class="logs-table-cell">Used on</div>
                        </div>
    ...
    <div class="logs-table-row">
                            <div class="row flex-wrap">
                                <div class="col-6 col-md-2">
                                    <div class="logs-table-cell">{{ $invitation->code }}</div>
                                </div>
                                <div class="col-6 col-md-2">
                                    <div class="logs-table-cell">{!! $invitation->user->displayName !!}</div>
                                </div>
                                <div class="col-6 col-md-2">
...
@else
    ...
    @endif
                                ...
                                <div class="col-6 col-md-2">
                                    <div class="logs-table-cell">
                                        @if ($invitation->created_at != $invitation->updated_at)
    {!! pretty_date($invitation->updated_at) !!}
@else
    ---
    @endif
                                    </div>
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="logs-table-cell">{!! pretty_date($invitation->created_at, false) !!}</div>
                                </div>
