...
class GalleryController extends Controller {
    ...
    */
    ...
    public function postCreateEditGallery(Request $request, GalleryService $service, $id = null) {
        ...
        $data = $request->only([
            'name', 'sort', 'parent_id', 'description', 'submissions_open', 'currency_enabled', 'votes_required', 'start_at', 'end_at', 'hide_before_start', 'prompt_selection', 'location_selection', 'criterion_id', 'criterion'
        ]);
