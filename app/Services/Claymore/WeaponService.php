    ...
    **********************************************************************************************/
    ...
    public function deleteWeapon($weapon)
    {
        ...
        try {
            ...
            if(DB::table('user_weapons')->where([['weapon_id', '=', $weapon->id], ['count', '>', 0]])->exists()) throw new \Exception("At least one user currently owns this weapon. Please remove the weapon(s) before deleting it.");
